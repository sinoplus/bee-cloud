DROP DATABASE IF EXISTS `bee-cloud`;

CREATE DATABASE `bee-cloud` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
values (100, 0, '0', '小熊科技', 0, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '广州总公司', 1, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, '小熊', '18222222222', '222222222@qq.com', '0', '0', 'admin', sysdate(),
        '',
        null);
...
values (1, 103, 'admin', '小熊', 'sys_user', '222222222@qq.com', '18222222222', '1', '',
        '$2a$10$0V8QKKev7xvkoghQyBvXHORFb8tfjeBNWUfQTLpuSz1DwNU/ltxYG', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员');
insert into sys_user
values (2, 105, 'bear', '小熊', 'sys_user', '222222222@qq.com', '18222222222', '1', '',
        '$2a$10$iVID9ItAzNhTJ7FIaz/jyuOAR2iy0LvVRYyLi8bZ8PMBKiTe7K3XG', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '测试员');
...
values ('1', '温馨提醒：2023-05-23 新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice
values ('2', '维护通知：2023-05-01 系统凌晨维护', '1', '维护内容', '0', 'admin', sysdate(), '', null, '管理员');
...
values (1, 'minio', 'bee', 'bee123', 'bee', '', '127.0.0.1:9000', '', 'N', '', '1', '0', '', 'admin', sysdate(),
        'admin', sysdate(), NULL);
insert into sys_oss_config
values (2, 'qiniu', '75FA0rtm_w_hldKrAjmPsO28qQP0IhxJNR0OoIBX', 'gFEatl3Dg6MI_5rGV41X2eSWMOOcOv4lSIailDwb', 'beecloudtest', '', 's3-cn-east-1.qiniucs.com', 'rv9lk87ae.hd-bkt.clouddn.com', 'N', '', '1', '1',
        '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config
values (3, 'aliyun', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'bee', '', 'oss-cn-beijing.aliyuncs.com', '', 'N', '', '1',
        '1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config
values (4, 'qcloud', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'bee-1250000000', '', 'cos.ap-beijing.myqcloud.com', '', 'N',
        'ap-beijing', '1', '1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config
values (5, 'image', 'bee', 'bee123', 'bee', 'image', '127.0.0.1:9000', '', 'N', '', '1', '1', '', 'admin', sysdate(),
        'admin', sysdate(), NULL);
